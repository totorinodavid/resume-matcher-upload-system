    ...
    getResume(resume_id)
      ...
      .catch(e => {
        ...
        if (errorMessage.includes('Unauthorized') || errorMessage.includes('401')) {
          setError('Du musst angemeldet sein, um diesen Lebenslauf zu sehen.');
        } else {
